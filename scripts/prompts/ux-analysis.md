...
Design language: Material Design 3; follows the system light/dark theme. Sushi Green (#2F7D4E) primary, Sushi Ink (#0E1B16) headlines, Sushi Mist (#F2F5F3) background; terminal surfaces from the Foundations page (Panel Dark #131C1A, Text #E6F1ED). Portrait first; adaptive layouts are a far-future item.
